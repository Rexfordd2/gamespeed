...
export const GameHeader = ({
  ...
  return (
    ...
    >
      <div
        className="pointer-events-auto mx-auto mt-2 flex w-full max-w-5xl items-center gap-2 rounded-2xl border px-2.5 py-2 sm:mt-3 sm:gap-4 sm:px-4 sm:py-3"
        style={{
      ...
      >
        <div className="flex items-center gap-2 sm:gap-4">
          <div className="flex flex-col items-start min-w-[64px] sm:min-w-[72px]">
            <span
            ...
            <motion.span
              ...
              className="text-lg sm:text-2xl font-extrabold leading-none tabular-nums"
            >
              {score}
            </motion.span>
          </div>
        ...
        <div className="mx-0.5 sm:mx-2 flex flex-1 flex-col items-center overflow-hidden px-0.5 sm:px-4">
          <span
          ...
          <motion.span
            ...
            className="text-base sm:text-2xl font-bold tabular-nums leading-none mt-0.5"
        ...
        <div className="flex items-center justify-end gap-1.5 sm:gap-2 min-w-[94px] sm:min-w-[116px]">
          <button
            type="button"
            onClick={onMainMenu}
