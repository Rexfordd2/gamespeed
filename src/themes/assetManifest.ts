...
export const jungleAssetManifest = {
  ...
  audio: {
    ...
    mode: {
      ...
      instinctHiss: resolveAudioCueAsset('mode', 'instinct-hiss'),
      instinctGrowl: resolveAudioCueAsset('mode', 'instinct-growl'),
      instinctWater: resolveAudioCueAsset('mode', 'instinct-water'),
    },
    ui: {},
  },
  ui: {
